...
public class JsonUtil {
    ...
    /**
     *  根据集合的Json字符串反序列化为Java中的集合
     * @param str  拥有集合的Json字符串
     * @param collectionClass 集合的Class文件
     * @param elementClasses  集合元素Calss文件
     * @param <T>
     * @return
     */
    ...
    public static void main(String[] args) throws IOException {
        ...
        String userJsonPretty = JsonUtil.objToStringPretty(u1);
